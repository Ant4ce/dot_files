...
#The below commeted section is the old default highlightinjg for bash, up to unset color....
#if [ "$color_prompt" = yes ]; then
...
if [ -x /usr/bin/dircolors ]; then
    ...
    alias ls='ls --color=auto' #alias dir='dir --color=auto' #alias vdir='vdir --color=auto'
...
alias l='ls -CF'
#my aliases
#my cyberghost aliases
alias cgch='sudo cyberghostvpn --traffic --country-code CH --connect'
...
alias cgt='sudo cyberghostvpn --stop'
...
export PATH="$PATH:/home/wesselweernink/.local/bin:/home/di0/go/bin:/usr/local/bin:$HOME/.local/bin"
